...
<head>
    ...
    <?php include("other-php/register.php")?>
</head>
    ...
    <div class="logIn">
        <div class="center-div m-5">
            <form method="post" action="">
                ...
                <input type="text" name="username" class="mb-3" required><br>

                <label for="user_password">Password:</label>
                <input type="password" name="user_password" class="mb-3" required><br>

                <label for="confirm_password">Confirm Password:</label>
                <input type="password" name="confirm_password" class="mb-3" required><br>

                <label for="user_email">Email:</label>
                <input type="email" name="user_email" class="mb-3" required><br>
